    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_start_intent_service:
                Intent mStartInentService = new Intent(MainActivity.this, DicodingIntentService.class);
                mStartInentService.putExtra(DicodingIntentService.EXTRA_DURATION, 5000);
                startService(mStartInentService);
                break;
        }
    }
}
