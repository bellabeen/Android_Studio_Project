...
public class CardViewAnimalAdapter extends RecyclerView.Adapter<CardViewAnimalAdapter.CardViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CardViewHolder cardViewHolder, int i) {
        ...
        cardViewHolder.btnFavorite.setOnClickListener(new CustomOnItemClickListener(i, new CustomOnItemClickListener.OnItemClickCallback() {
            ...
            public void onItemClicked(View view, int position) {
                Toast.makeText(context, "Favorite " + getListAnimal().get(position).getName(), Toast.LENGTH_SHORT).show();
            }
        }));
